...
import { deleteReasonsData, getReasonsData } from '../services/api'; 
import SkeletonLoader from '../loader/SkeletonLoader';
import AddReasons from './modals/AddReasons';
import EditReasons from './modals/EditReasons';
...
export default  function Reasons() {
  ...
  const loadStudyStepData = useCallback(async () => {
    setLoading(true);
    try {
      const data = await getReasonsData();
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="page-title text-4xl">Reasons</h1>
                ...
                {items.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="text-sm text-muted-foreground line-clamp-2">{item.text}</span>
                      </td>
                      <td className="px-4 py-3">
