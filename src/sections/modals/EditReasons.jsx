...
import { updateReasonsData,  } from '../../services/api';

export default function EditReasons({ item, onClose, onRefresh }) {
 ...
 const handleSubmit = async (e) => {
    ...
    try {
      const response = await updateReasonsData(item.id, formData);
    ...
    <div className="modal-overlay p-4">
      <div className="modal-panel">
        ...
        <div className="modal-header">
          <h2 className="text-2xl font-bold text-foreground">Edit Reasons</h2>
          <button
            onClick={onClose}
            className="icon-btn"
          >
