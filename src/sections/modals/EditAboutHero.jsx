...
export function EditAboutHero({ hero, onRefresh, onClose }) {
  ...
  if (file) {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        dataToSend.append("background_image", formData.background_image);
        dataToSend.append("_method", "POST");
     

        if (bgFile) {
           dataToSend.append("background_image", bgFile);
        }
