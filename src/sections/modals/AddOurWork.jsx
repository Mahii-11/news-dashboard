...
import { storeOurWorkData } from '../../services/api';
...
export default function AddOurWork({ isOpen, onClose, onAdd }) {
  ...
  // Modal open না থাকলে কিছুই রেন্ডার করবে না
  ...
  const handleSubmit = async (e) => {
    ...
    // ইমেজ সিলেক্ট করা বাধ্যতামূলক হলে এই কন্ডিশন অন করতে পারেন
    if (!selectedFile) {
    ...
    try {
      ...
      // আপনার API কল
      const response = await storeOurWorkData(dataToSend);
      
      if (response) {
        // ফর্ম রিসেট করা
        setFormData({ title: '', sub_title: '', description: '', technology: '', link: '' });
        setPreview(null);
        setSelectedFile(null);
        
        if (onAdd) onAdd(); // টেবিল ডেটা রিফ্রেশ করার জন্য
