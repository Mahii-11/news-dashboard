...
import { updateTopCategoriesData,  } from '../../services/api';

export default function EditCategories({ item, onClose, onRefresh }) {
 ...
 const handleSubmit = async (e) => {
    ...
    try {
      const response = await updateTopCategoriesData(item.id, formData);
    ...
    <div className="modal-overlay p-4">
      <div className="modal-panel">
        ...
        <div className="modal-header">
          <h2 className="text-2xl font-bold text-foreground">Edit Stats Item</h2>
          <button
            onClick={onClose}
            className="icon-btn"
          >
