...
import { Trash2, Loader2, Image as ImageIcon, Edit2, Plus } from "lucide-react";
import { getOurStoriesData , deleteOurStoriesData } from "../services/api";
import SkeletonLoader from "../loader/SkeletonLoader";
import AddOurStories from "./modals/AddOurStories";
import EditOurStories from "./modals/EditOurStories";
...
export default function Capability() {
  ...
  const loadHighlightCardsData = useCallback(async () => {
    setLoading(true);
    try {
      const data = await getOurStoriesData ();
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">OurStories</h1>
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="w-16 h-16 rounded-lg overflow-hidden bg-muted flex items-center justify-center border border-accent/10">
                         ...
                         <td className="px-4 py-3">
                        <span className="text-xs text-foreground line-clamp-3">{item.title}</span>
                      </td>
                       ...
                       <td className="px-4 py-3">
                        ...
                        <span className="text-sm text-muted-foreground line-clamp-2">{item.long_description}</span>
