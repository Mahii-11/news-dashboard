                ...
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground w-32">
                    Description
                       ...
                       <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground w-16">
                    Count(`1`)
                      </th>
                       <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground w-16">
                    Count(`2`)
                ...
                {heroes.map((hero, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                     ...
                     <td className="px-4 py-3">
                      <span className="font-medium text-xs text-foreground">{hero.stat_one_text}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="text-xs text-muted-foreground line-clamp-2">{hero.stat_two_text}</span>
                    </td>
                      <td className="px-4 py-3">
                      <span className="text-xs text-muted-foreground line-clamp-2">{hero.description}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="text-xs text-muted-foreground line-clamp-2">{hero.stat_one_count}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="text-xs text-muted-foreground line-clamp-2">{hero.stat_two_count}</span>
                    </td>
