...
import { deletecontactsData, getcontactsData } from '../services/api'; 
import SkeletonLoader from '../loader/SkeletonLoader';
import AddContacts from './modals/AddContacts';
import EditProcesses from './modals/EditProcesses';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="page-title text-4xl">Contact Requests</h1>
                    ...
                    >
                      <td className="px-4 py-3">
                        <span className="font-medium text-sm text-foreground">{item.name}</span>
                           ...
                           <td className="px-4 py-3">
                        <span className="font-medium text-sm text-foreground">{item.email}</span>
                          </td>
                           <td className="px-4 py-3">
                        <span className="font-medium text-sm text-foreground">{item.subject}</span>
                      </td>
                      <td className="px-4 py-3">
                        <span className="text-sm text-muted-foreground line-clamp-2">{item.message}</span>
                      </td>
                      <td className="px-4 py-3">
